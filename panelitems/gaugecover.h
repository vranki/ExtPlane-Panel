...
public:
    Q_INVOKABLE GaugeCover(QObject *parent, ExtPlaneConnection *conn);
    ...
    void drawCoverImage();
    void drawCoverImageGuageFitting(QPainter *painter, int centerX, int centerY, int size);
    void drawCoverImageLightFitting(QPainter *painter, int centerX, int centerY, int width, int height);
